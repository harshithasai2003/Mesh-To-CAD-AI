# Macro Begin: C:\Users\pawar\AppData\Roaming\FreeCAD\v1-1\Macro\2.FCMacro +++++++++++++++++++++++++++++++++++++++++++++++++
import FreeCAD
import PartDesign
...
# Gui.Selection.addSelection('Unnamed','Body','Origin.XZ_Plane.',11.0805,-2.03042e-06,17.0324)
...
# Gui.getDocument('Unnamed').resetEdit()
App.getDocument('Unnamed').getObject('Sketch').Visibility = False
# Gui.Selection.addSelection('Unnamed','Body','Pad.Face3',8.66988,-80,21.3361)
...
constraintList = []
App.getDocument('Unnamed').getObject('Sketch001').addConstraint(Sketcher.Constraint('Diameter',0,80.000000)) 
...
constraintList = []
App.getDocument('Unnamed').getObject('Sketch001').addConstraint(Sketcher.Constraint('Diameter',1,50.000000)) 
...
### End command PartDesign_Pad
# Gui.Selection.clearSelection()
App.getDocument('Unnamed').getObject('Pad001').Length = 20.000000
...
App.getDocument("Unnamed").saveAs(u"D:/UBT/Modelling seminar - II/CAD/2/2.FCStd")
...
if hasattr(Mesh, "exportOptions"):
    options = Mesh.exportOptions(u"D:/UBT/Modelling seminar - II/CAD/2/2-Body.stl")
    Mesh.export(__objs__, u"D:/UBT/Modelling seminar - II/CAD/2/2-Body.stl", options)
else:
    Mesh.export(__objs__, u"D:/UBT/Modelling seminar - II/CAD/2/2-Body.stl")

del __objs__
### End command Std_Export
# Macro End: C:\Users\pawar\AppData\Roaming\FreeCAD\v1-1\Macro\2.FCMacro +++++++++++++++++++++++++++++++++++++++++++++++++
