...
sketch.addConstraint(Sketcher.Constraint('Diameter', 0, 68))
...
sketch2.addGeometry(Part.Circle(App.Vector(34.0, 0, 0), App.Vector(0, 0, 1), 3.0), False)
sketch2.addConstraint(Sketcher.Constraint('DistanceX', -1, 1, 0, 3, 34.0))
sketch2.addConstraint(Sketcher.Constraint('DistanceY', -1, 1, 0, 3, 0.0))
sketch2.addConstraint(Sketcher.Constraint('Radius', 0, 4.83))
...
doc.saveAs(r"C:/Users/harsh/OneDrive/Desktop/SCIENTIFIC COMPUTING/THIRD SEMESTER/MODELLING SEMINAR B/Variants/13_Variants/13_070.FCStd")

__objs__ = []
__objs__.append(FreeCAD.getDocument(doc.Name).getObject("Body"))
if hasattr(Mesh, "exportOptions"):
    options = Mesh.exportOptions(r"C:/Users/harsh/OneDrive/Desktop/SCIENTIFIC COMPUTING/THIRD SEMESTER/MODELLING SEMINAR B/Variants/13_Variants/13_070.stl")
    Mesh.export(__objs__, r"C:/Users/harsh/OneDrive/Desktop/SCIENTIFIC COMPUTING/THIRD SEMESTER/MODELLING SEMINAR B/Variants/13_Variants/13_070.stl", options)
else:
    Mesh.export(__objs__, r"C:/Users/harsh/OneDrive/Desktop/SCIENTIFIC COMPUTING/THIRD SEMESTER/MODELLING SEMINAR B/Variants/13_Variants/13_070.stl")
del __objs__
